...
function [X,Y,Z,breakrib,Nribs,Scale2] = Structural_SES_Creator(DesignVariables,Setup)
...
Mesh=['ui_exec_function( "mesh_seed_display_mgr", "init" )\n'...
    ...
    'fem_create_mesh_surf_4( "IsoMesh", 49152, "Surface %s", 1, ["%1.1f"],  @\n'...
...
SkinGroup=['ga_group_create( "Skin" )\n'...
        'ga_group_entity_add( "Skin", "Surface %1.0f")\n'];
...
for i=1:Sections
    ...
    fprintf(fidw,Mesh,P4,Setup.Settings.Mesh.Size,Setup.Settings.Mesh.Type,P1);
    fprintf(fidw,GroupCommand,P1,P1,P4);
    clear P4
end

P5=cell2mat(P5);
fprintf(fidw,SkinGroup,P5);
clear P5
% Ribs Properties

RibsGroup=['ga_group_create( "Ribs" )\n'...
        'ga_group_entity_add( "Ribs", "Surface %1.0f")\n'];
